...
const Home = () => {
  return (
    ...
    {/* <div class="items-center justify-center text-center"> */}
      ...
      <h1 class="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-slate-900 sm:text-7xl">Share your AI prompt <br className="max-md:hidden"/>
          <span class="relative whitespace-nowrap text-emerald-400">
              ...
              <span class="relative mx-2">Ideas</span>
          </span> 
      </h1>
  ...
  {/* <Feed /> */}
    ...
    //     <span className="emerald_gradient text-center">The place where people can share and discuss AI prompt ideas</span>
    //     </h1>
