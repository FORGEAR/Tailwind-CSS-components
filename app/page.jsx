...
const Home = () => {
  return (
    ...
    {/* <div class="items-center justify-center text-center"> */}
      ...
      <p class="desc text-center mt-12"> Build beautiful, responsive websites with Tailwind CSS components.<br/>Our library of pre-built components makes it easy to get started with Tailwind CSS, and you can customize them to match your unique style.</p>
